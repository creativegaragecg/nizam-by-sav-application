...
//
//     final myUnits = myUnitsFromJson(jsonString);

import 'dart:convert';

MyUnits myUnitsFromJson(String str) => MyUnits.fromJson(json.decode(str));

String myUnitsToJson(MyUnits data) => json.encode(data.toJson());
...
class MyUnits {
  ...
  factory MyUnits.fromJson(Map<String, dynamic> json) => MyUnits(
...
class Unit {
  ...
  factory Unit.fromJson(Map<String, dynamic> json) => Unit(
    ...
    installmentStartDate: json["installment_start_date"] == null ? null : DateTime.parse(json["installment_start_date"]),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "installment_start_date": installmentStartDate?.toIso8601String(),
